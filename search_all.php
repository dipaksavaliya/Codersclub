...
<div id="fade" class="black_overlay"></div>
        ...
        <h2>Search..</h2><br>
        <a href="search_ruser.php">Search Registered Users..</a><br>
        <a href="search_pro.php">Search Project List By Title..</a><br>
        <a href="search_tech.php">Search Project List By Technologies..</a><br> 
        <img src="images/lo.bmp" alt="CodersClub.com" height="100%" width="100%">
