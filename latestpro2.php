...
<h2>Latest featured Projects</h2><div class="clr"></div>
          <p>Posted by <a href="#">CodersClub.com</a> &nbsp;|&nbsp; What Its <a href="hwitwrks2.php">mean</a>,&nbsp;| Read <a href="about2.php">More</a> &nbsp;|&nbsp;<?php
    print (date("l dS F Y"));
?></p>
         <?php
