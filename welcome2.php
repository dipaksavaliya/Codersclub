    ...
    <div class="content_resize">
      ...
      <div class="mainbar">
        ...
        <div class="article">
          ...
          <p>Posted by <a href="#">CodersClub.com</a> &nbsp;|&nbsp; What Its <a href="hwitwrks1.php">mean</a>,&nbsp;| Read <a href="about.php">More</a> &nbsp;|&nbsp;<?php
    print (date("l dS F Y"));
?></p>
...
which means that you are free to use it for any personal or commercial purpose that provided you on this site <a href="#">CodersClub.com</a>.</p>
          <p class="spec"><a href="about2.php" class="rm">Read more</a> &nbsp;|&nbsp; <a href="contact2.php" class="com">Comments</a> &nbsp;|&nbsp; <span class="date"><?php
    print (date("l dS F Y"));
?></span></p>
        </div>
        ...
        <div class="article">
          ...
          <div class="clr"></div>
<?php
    include_once('latestprodis2.php');
?>
        </div>
            </div>
