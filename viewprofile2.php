  ...
  <div class="content">
    ...
    <div class="content_resize">
      ...
      <div class="mainbar">
        ...
        <div class="article">
                   <h2><span>My Profile</span></h2><hr><div class="clr"></div>
    ...
    $qrypf="SELECT login.fname, login.lname, login.gender, login.email, login.skill, country.cname, state.sname, city.city, login.addskill, login.companyname, login.companyadd, login.userid FROM login inner join state
               on login.state=state.sid inner join country
               on login.country=country.cid inner join city
               on login.city=city.cityid inner join user
               on login.userid=user.userid where user.userid='$profile' ";
    $rs=mysql_query($qrypf);
    while($row_sel=mysql_fetch_array($rs))
    {
        ?>
        <table align="left" cellpadding="10" cellspacing="5">
        <tr><td>Name</td><td> : <?php echo $row_sel['fname']; ?> &nbsp;&nbsp;<?php echo $row_sel['lname']; ?></td></tr>
        <tr><td>Gender</td><td> : <?php echo $row_sel['gender']; ?></td></tr>
        <tr><td>E-mail</td><td> : <?php echo $row_sel['email']; ?></td></tr>
        <tr><td>Skill</td><td> : <?php echo $row_sel['skill']; ?></td></tr>
        <tr><td>Country</td><td> : <?php echo $row_sel['cname']; ?></td></tr>
        <tr><td>State</td><td> : <?php echo $row_sel['sname']; ?></tr></td>
        <tr><td>City</td><td> : <?php echo $row_sel['city']; ?></tr></td>
        <tr><td>Add Skill</td><td> : <?php echo $row_sel['addskill']; ?></td></tr>
        <tr><td>Company name</td><td> : <?php echo $row_sel['companyname']; ?></td></tr>
        <tr><td>Company Address</td><td> : <?php echo $row_sel['companyadd']; ?></td></tr>
