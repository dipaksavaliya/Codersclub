...
<script type="text/javascript" src="js/sproclienthint.js"></script>
</head>
<body>
<div class="main">
  ...
  <div class="content">
    ...
    <div class="content_resize">
      ...
      <div class="mainbar">
        ...
        <div class="article">
          <h2><span>Search Projects</span> here by title..</h2>
          <div class="clr"></div>
<form method="post">
Project Name: &nbsp;<input type="text" id="txt1" name="txt" onkeyup="showHint(this.value)" class="text" />
...
<th width="450px">Project defination :</th>
</tr>  
             <?php
              $pronme=$_POST['txt'];
              $proname="select proname, prodef from project where proname like '%$pronme%'";
