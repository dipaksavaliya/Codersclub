  ...
  <div class="content">
    ...
    <div class="content_resize">
      ...
      <div class="mainbar">
        ...
        <h2>Search..</h2><br>
        <a href="search_ruser2.php">Search Registered Users..</a><br>
        <a href="search_pro2.php">Search Project List By Title..</a><br>
        <a href="search_tech2.php">Search Project List By Technologies..</a><br> 
