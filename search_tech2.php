...
<script type="text/javascript" src="js/stechclienthint.js"></script>
</head>
<body>
<div class="main">
  ...
  <div class="content">
    ...
    <div class="content_resize">
      ...
      <div class="mainbar">
        ...
        <div class="article">
          <h2><span>Search Projects</span> here technologies wise..</h2>
          <div class="clr"></div>
<form method="post" >
Technologies : <input type="text" name="txt" onkeyup="showHint(this.value)" class="text"/>
<p>Suggestion :<span id="txtHint"></span></p>


<input type="submit" value="Search Project" name="btn"/> 
</form>
...
<th width="70px">Project Name :</th>
<th width="350px">Project defination :</th>
<th width="125px">Project Tech :</th>
</tr>
<?php
    
              $proname="select proname, prodef, protech from project where protech like '$protech%' ";
                ...
                {   
                    ...
                    echo "<td>".$row['prodef']."</td>";
                    echo "<td>".$row['protech']."</td></tr>"; 
                    $i++;
                }
            }
              ?>
