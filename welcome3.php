...
which means that you are free to use it for any personal or commercial purpose that provided you on this site <a href="#">CodersClub.com</a>.</p>
          <p class="spec"><a href="about3.php" class="rm">Read more</a> &nbsp;|&nbsp; <a href="contact3.php" class="com">Comments</a> &nbsp;|&nbsp; <span class="date"><?php
    print (date("l dS F Y"));
?></span></p>
        </div>
        ...
        <div class="article">
          ...
          <div class="clr"></div>
<?php
    include_once('latestprodis3.php');
?>
