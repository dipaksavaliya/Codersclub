    ...
    <div class="content_resize">
      ...
      <div class="mainbar">
        ...
        <div class="article">
         ...
         <div class="clr">
 <h2><span>My Project</span></h2><hr>        
<?php
    include_once('conn.php');
    session_start();
      $profile=$_SESSION['uname'];

 $qryp="select * from project inner join login on project.userid=login.userid where username='$profile'";  
    $ra=mysql_query($qryp);
    $i=1;
     while($row_sel=mysql_fetch_array($ra))
    {
        ?>
        <table align="left" cellpadding="10" cellspacing="5">
        <td><?php echo $i; ?></td>
   <td>Project Title&nbsp;&nbsp;&nbsp;&nbsp;:</b><?php echo $row_sel['proname'];  ?></td>
          <td><b>Required skills&nbsp;&nbsp;:</b><?php echo $row_sel['protech'];?></td>
          <td><b>ProjectDefination:</b><?php echo $row_sel['prodef'];?></td>
          <td><b>Project Budget&nbsp;&nbsp;&nbsp;:</b><?php echo $row_sel['probudget'];?></td>
          <td><b>Bid Period&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b> <?php echo $row_sel['bidperiod'];?></td>
